...
urlpatterns = [
    path("", views.resources_view, name="liste"),
    path("gratuites/", views.resources_view, {"mode": "free"}, name="free_liste"),
    path("premium/", views.resources_view, {"mode": "premium"}, name="premium_liste"),
